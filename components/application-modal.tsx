...
function ApplicationFormModal({
  ...
  // Step 1 -> Step 2 (no API call here, just validation + move forward)
      ...
      <div className="relative z-10 max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-border bg-card shadow-2xl transition-all duration-300 animate-in fade-in-0 zoom-in-95 slide-in-from-bottom-4">
        {step === "success" ? (
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleFinalSubmit} className="mt-5 space-y-4" noValidate>
              {/* Passport Size Photo */}
              <div>
          ...
          <div className="p-6">
            ...
            <form onSubmit={handleFirstStepSubmit} className="mt-5 space-y-4" noValidate>
              <div>
